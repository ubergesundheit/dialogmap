...
L.extend(L.GeoJSON, {
	...
	getFeature: function (layer, newGeometry) {
		return layer.feature ? L.extend({}, layer.feature, {geometry: newGeometry}) : L.GeoJSON.asFeature(newGeometry, layer.options.properties);
	},
    ...
    if(typeof properties === "undefined") {
      console.log('properties is undefined!!!');
    }
		return {
			type: 'Feature',
